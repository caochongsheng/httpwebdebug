 ...
 * HttpCaptureMainActivity
 */
public class HttpCaptureMainActivity extends AppCompatActivity implements BackHandledInterface {
    ...
    private HttpCaptureMainActivity.Receiver receiver;
...
//    Boolean isMove = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_httpcapturemian);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        rootView = findViewById(R.id.fl_contain);
        ...
        previewFab = (FloatingActionButton) findViewById(R.id.fab_preview);
        clearFab = (FloatingActionButton) findViewById(R.id.fab_clear);

        initFloatingActionMenu();

        HttpCaptureMainActivity.OnGlobalLayoutListener globalLayoutListener = new HttpCaptureMainActivity.OnGlobalLayoutListener(rootView);
    ...
    public NavigationView.OnNavigationItemSelectedListener navigationItemListener = new NavigationView.OnNavigationItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(MenuItem item) {
            ...
            if (!SysApplication.isInitProxy) {
                Toast.makeText(HttpCaptureMainActivity.this, "请等待程序初始化完成", Toast.LENGTH_LONG).show();
                return true;
            }
            if (id == R.id.nav_camera) {
                Intent intent = new Intent(HttpCaptureMainActivity.this, QrCodeScanActivity.class);
...
//            }
                ...
                Intent intent = new Intent(HttpCaptureMainActivity.this, SettingsActivity.class);
                startActivity(intent);
            } else if (id == R.id.nav_ua) {
                showUaDialog();
            } else if (id == R.id.nav_modify) {
                if(shp.getBoolean("enable_filter", false)) {
                    Intent intent = new Intent(HttpCaptureMainActivity.this, ChangeFilterActivity.class);
                    startActivity(intent);
                }else {
                    Toast.makeText(HttpCaptureMainActivity.this, "请前往设置启用注入功能", Toast.LENGTH_LONG).show();
                }
...
//            setSelectedFragment((BaseFragment) to);
    ...
    protected void onStart() {
        super.onStart();
        receiver = new HttpCaptureMainActivity.Receiver();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    HttpCaptureMainActivity.this.runOnUiThread(callback);
                } catch (Exception e) {
                    rootView.post(new Runnable() {
                        @Override
                        public void run() {
        ...
        public void onCompleted(UploadInfo uploadInfo, ServerResponse serverResponse) {
            try {
                ...
                if (jsonObject.getInt("errId") == 0) {
                    ...
                    showUploadDialog(HttpCaptureMainActivity.this);
                } else {
                    Snackbar.make(rootView, "上传失败！", Snackbar.LENGTH_LONG).setAction("Action", null).show();
                }
            } catch (Exception e) {
...
//        final String uuid = SystemBasicInfo.getUUID(this);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                edtInput.setText("");
                Glide.with(HttpCaptureMainActivity.this).load(CODE_URL + "?key=" + key + "&scene=2&t=" + Math.random()).into(imageView);
            }
        });
            ...
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                Runnable runnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        showLoading("上传中");
                        FileUtils.uploadFiles(HttpCaptureMainActivity.this, new HttpCaptureMainActivity.MyUploadDelegate(), serverUrl, "upload", Environment.getExternalStorageDirectory() + "/test.zip");
                    }
                };
                createZip(runnable);
            }
...
//    }
    ...
    public void initFloatingActionMenu() {
        ...
        shareFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showFilter(HttpCaptureMainActivity.this,TYPE_SHARE);
                fam.close(true);
            }
        });
        ...
        uploadFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showFilter(HttpCaptureMainActivity.this,TYPE_UPLOAD);
                fam.close(true);
            }
        });
        ...
        clearFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(HttpCaptureMainActivity.this);
    ...
    public void showUaDialog() {
        DialogInterface.OnClickListener buttonListener = new HttpCaptureMainActivity.ButtonOnClick();
        ...
        public void onClick(DialogInterface dialog, int which) {
            if (which >= 0) {
                ...
                if (which == DialogInterface.BUTTON_POSITIVE) {
                    SharedPreferenceUtils.putString(HttpCaptureMainActivity.this, "select_ua", index + "");
    ...
    public void showHostDialog(){
        ...
        builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SharedPreferenceUtils.putString(HttpCaptureMainActivity.this, "system_host", editText.getText()+"");
        ...
        builder.setNegativeButton("清空", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
                imm.hideSoftInputFromWindow(editText.getWindowToken(), 0);
                SharedPreferenceUtils.putString(HttpCaptureMainActivity.this, "system_host", "");
                DeviceUtils.changeHost(((SysApplication)getApplication()).proxy,editText.getText()+"");
            }
        });
        builder.show();
