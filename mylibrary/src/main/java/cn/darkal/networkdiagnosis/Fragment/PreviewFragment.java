...
public class PreviewFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(((HttpCaptureMainActivity) getActivity()).searchView!=null){
            ((HttpCaptureMainActivity) getActivity()).searchView.setVisibility(View.VISIBLE);
        }
        ...
        public Filter getFilter() {
            return new Filter() {
                ...
                protected FilterResults performFiltering(CharSequence constraint) {
                    harLog = ((HttpCaptureMainActivity) getActivity()).getFiltedHar().getLog();
                    //初始化过滤结果对象
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
//            ((WebDebugActivity2) getActivity()).navigationView.setCheckedItem(R.id.nav_preview);
            notifyHarChange();
        }
    }
    ...
    public void onResume() {
        ...
        if(recyclerView!=null) {
            ...
            if(((HttpCaptureMainActivity)getActivity()).searchView!=null) {
                filterItem(((HttpCaptureMainActivity) getActivity()).searchView.getQuery());
            }
        }
    }
}
